...
import categoriesStoresAction from '../../store/CategoriesStores/actions'
import { useDispatch,useSelector } from 'react-redux'
import { Icon } from '@rneui/themed'

const {captureCategoriesStores} = categoriesStoresAction
...
export default function DropDownStores() {
  ...
  const dispatch = useDispatch();
    ...
    const handleReset = () => {
      setValue(null);
      dispatch(captureCategoriesStores({ inputCategory: [] })); 
    }

    const handleChange = item => {
      setValue(item.value);
      setIsFocus(false);
      dispatch(captureCategoriesStores({inputCategory: item.value})); 
    };
